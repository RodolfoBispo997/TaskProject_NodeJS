...
describe("UsersController", () => {
  ...
  beforeEach(async () => {
    ...
    cloudinaryService =
      await module.resolve<CloudinaryService>(CloudinaryService);
  });
  ...
  describe("uploadAvatar", () => {
    it("should upload avatar and update user", async () => {
      ...
      jest
        ...
        .mockResolvedValue({ url: avatarUrl });
      jest
        .spyOn(service, "update")
        .mockResolvedValue({ ...user, avatar: avatarUrl });
      jest
        .spyOn(service, "findById")
        .mockResolvedValue({ ...user, avatar: avatarUrl } as any);
