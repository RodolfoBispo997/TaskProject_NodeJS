...
describe("CollaboratorsService", () => {
  ...
  beforeEach(async () => {
    ...
    service = await module.resolve<CollaboratorsService>(CollaboratorsService);
  ...
  it("should return a paginated list of collaborators by project", async () => {
    jest
      .spyOn(prisma.projectCollaborator, "findMany")
      .mockResolvedValue(mockedCollaborators as any);
    jest
      .spyOn(prisma.projectCollaborator, "count")
      .mockResolvedValue(mockedCollaborators.length);
  ...
  it("should create a new collaborator", async () => {
    ...
    jest
      .spyOn(prisma.projectCollaborator, "create")
  ...
  it("should update a collaborator", async () => {
    ...
    jest
      ...
      .mockResolvedValue(collaborator);
    jest
      .spyOn(prisma.projectCollaborator, "findUnique")
      .mockResolvedValue(collaborator);
  ...
  it("should delete a collaborator", async () => {
    ...
    jest
      .spyOn(prisma.projectCollaborator, "delete")
      .mockResolvedValue(collaborator);
    jest
      .spyOn(prisma.projectCollaborator, "findUnique")
      .mockResolvedValue(collaborator);
